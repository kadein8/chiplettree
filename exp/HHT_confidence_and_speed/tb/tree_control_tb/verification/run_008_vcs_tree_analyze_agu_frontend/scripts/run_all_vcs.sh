...
SUMMARY_FILE="${LOG_DIR}/run_008_summary.txt"
...
declare -a SCRIPT_LIST=(
    ...
    "run_tb_sram_subbank_stage_c_basic.sh"
    "run_tb_sram_bank_stage_c_parallel.sh"
    "run_tb_sram_subsystem_stage_c_route.sh"
    "run_tb_tree_analyze_agu_layered_frontier.sh"
)

overall_rc=0

{
    echo "run_name=run_008_vcs_tree_analyze_agu_frontend"
