...
localparam integer NUM_GEN_TOKENS = 2;
...
initial begin
    ...
    begin
        ...
        $display("SRAM preload: %0d beats", preload_cnt);
    end
...
always @(posedge clk) begin
    ...
    // One-shot: when tree_analyze accepts
