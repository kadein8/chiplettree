...
module tb_control_chip_dual_tree_near_steady_state_closure;
...
initial begin
    ...
    if (error_flag) begin
        $fatal(1,
               "control_chip should close the bounded dual-tree run without error");
    end

    $display("tb_control_chip_dual_tree_near_steady_state_closure PASS");
    $finish;
end
