...
free_list u_free_list (
    ...
    .bundle_req_valid(1'b0),
    .bundle_req_ready(),
    .bundle_req_req_id({`REQ_ID_W{1'b0}}),
    .bundle_req_slot_valid({`TREE_FRONTIER_SLOTS{1'b0}}),
    .bundle_req_branch_id({(`TREE_FRONTIER_SLOTS*`BRANCH_ID_W){1'b0}}),
    .bundle_req_node_id({(`TREE_FRONTIER_SLOTS*`NODE_ID_W){1'b0}}),
    .bundle_req_size_subbank({(`TREE_FRONTIER_SLOTS*`KV_GROUP_LEN_W){1'b0}}),
    .bundle_req_shared({`TREE_FRONTIER_SLOTS{1'b0}}),
    .cand_resp_valid(cand_resp_valid),
    .cand_resp_grant(cand_resp_grant),
    .cand_resp_req_id(cand_resp_req_id),
    .cand_resp_sram_id(cand_resp_sram_id),
...
bank_state_table u_bank_state_table (
    ...
    .cand_bundle_valid(1'b0),
    .cand_bundle_ready(),
    .cand_bundle_req_id({`REQ_ID_W{1'b0}}),
    .cand_bundle_slot_valid({`TREE_FRONTIER_SLOTS{1'b0}}),
    .cand_bundle_branch_id({(`TREE_FRONTIER_SLOTS*`BRANCH_ID_W){1'b0}}),
    .cand_bundle_node_id({(`TREE_FRONTIER_SLOTS*`NODE_ID_W){1'b0}}),
    .cand_bundle_size_subbank({(`TREE_FRONTIER_SLOTS*`KV_GROUP_LEN_W){1'b0}}),
    .cand_bundle_shared({`TREE_FRONTIER_SLOTS{1'b0}}),
    .cand_bundle_sram_id({(`TREE_FRONTIER_SLOTS*`SRAM_ID_W){1'b0}}),
    .cand_bundle_bank_id({(`TREE_FRONTIER_SLOTS*`BANK_ID_W){1'b0}}),
    .cand_bundle_subbank_start({(`TREE_FRONTIER_SLOTS*`SUBBANK_ID_W){1'b0}}),
    .cand_bundle_group_len({(`TREE_FRONTIER_SLOTS*`KV_GROUP_LEN_W){1'b0}}),
    .alloc_resp_valid(alloc_resp_valid),
    .alloc_resp_grant(alloc_resp_grant),
    .alloc_resp_req_id(alloc_resp_req_id),
    .alloc_resp_sram_id(alloc_resp_sram_id),
