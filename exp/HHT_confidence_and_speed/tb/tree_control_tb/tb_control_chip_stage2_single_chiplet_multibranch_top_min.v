...
module tb_control_chip_stage2_single_chiplet_multibranch_top_min;
...
localparam [`NODE_ID_W-1:0] EXP_PARENT_NODE_ID = 4'd5;
localparam [SOURCE_ID_W-1:0] EXP_SLOT0_SOURCE_ID = 3'd2;
localparam [`TOKEN_ID_W-1:0] EXP_SLOT0_TOKEN_ID = 16'hca21;
localparam [`TOKEN_ID_W-1:0] EXP_SLOT0_REF_TOKEN_ID = 16'h8c21;
localparam [`POSITION_ID_W-1:0] EXP_SLOT0_REF_POS = 12'h020;
localparam [CONF_W-1:0] EXP_SLOT0_CONF = 8'd250;

localparam [SOURCE_ID_W-1:0] EXP_SLOT1_SOURCE_ID = 3'd0;
localparam [`TOKEN_ID_W-1:0] EXP_SLOT1_TOKEN_ID = 16'h1101;
localparam [`TOKEN_ID_W-1:0] EXP_SLOT1_REF_TOKEN_ID = 16'h9101;
localparam [`POSITION_ID_W-1:0] EXP_SLOT1_REF_POS = 12'h030;
localparam [CONF_W-1:0] EXP_SLOT1_CONF = 8'd210;

localparam [SOURCE_ID_W-1:0] EXP_SLOT2_SOURCE_ID = 3'd4;
localparam [`TOKEN_ID_W-1:0] EXP_SLOT2_TOKEN_ID = 16'h1501;
localparam [`TOKEN_ID_W-1:0] EXP_SLOT2_REF_TOKEN_ID = 16'h9501;
localparam [`POSITION_ID_W-1:0] EXP_SLOT2_REF_POS = 12'h033;
localparam [CONF_W-1:0] EXP_SLOT2_CONF = 8'd200;

localparam [SOURCE_ID_W-1:0] EXP_SLOT3_SOURCE_ID = 3'd1;
localparam [`TOKEN_ID_W-1:0] EXP_SLOT3_TOKEN_ID = 16'h1201;
localparam [`TOKEN_ID_W-1:0] EXP_SLOT3_REF_TOKEN_ID = 16'h9201;
localparam [`POSITION_ID_W-1:0] EXP_SLOT3_REF_POS = 12'h031;
localparam [CONF_W-1:0] EXP_SLOT3_CONF = 8'd180;
...
task expect_ready_mask;
    ...
    begin
        ...
        if ((hht_cand_ready !== expected_hht_ready) ||
            ...
            $fatal(1, "single-chiplet multibranch top ready mask mismatch");
        end
    end
endtask
...
task expect_window_slot;
    ...
    begin
        ...
        if (tree_window_slot_valid[slot_idx] !== expected_valid) begin
            $fatal(1, "single-chiplet multibranch slot valid mismatch");
        end
        if (expected_valid) begin
            if ((tree_window_source_id[(slot_idx*SOURCE_ID_W) +: SOURCE_ID_W] != expected_source_id) ||
                ...
                $fatal(1, "single-chiplet multibranch slot payload mismatch");
            end
        end
    end
endtask
...
task drive_candidate_window_once;
    begin
        hht_cand_valid = 1'b1;
        hht_parent_node_id = EXP_PARENT_NODE_ID;
        hht_token_id = EXP_SLOT1_TOKEN_ID;
        hht_referenced_token_id = EXP_SLOT1_REF_TOKEN_ID;
        hht_referenced_position = EXP_SLOT1_REF_POS;
        hht_confidence = EXP_SLOT1_CONF;
        ...
        draft_parent_node_id[(0*`NODE_ID_W) +: `NODE_ID_W] = EXP_PARENT_NODE_ID;
        draft_token_id[(0*`TOKEN_ID_W) +: `TOKEN_ID_W] = EXP_SLOT3_TOKEN_ID;
        draft_referenced_token_id[(0*`TOKEN_ID_W) +: `TOKEN_ID_W] = EXP_SLOT3_REF_TOKEN_ID;
        draft_referenced_position[(0*`POSITION_ID_W) +: `POSITION_ID_W] = EXP_SLOT3_REF_POS;
        draft_confidence[(0*CONF_W) +: CONF_W] = EXP_SLOT3_CONF;

        draft_parent_node_id[(1*`NODE_ID_W) +: `NODE_ID_W] = EXP_PARENT_NODE_ID;
        draft_token_id[(1*`TOKEN_ID_W) +: `TOKEN_ID_W] = EXP_SLOT0_TOKEN_ID;
        draft_referenced_token_id[(1*`TOKEN_ID_W) +: `TOKEN_ID_W] = EXP_SLOT0_REF_TOKEN_ID;
        draft_referenced_position[(1*`POSITION_ID_W) +: `POSITION_ID_W] = EXP_SLOT0_REF_POS;
        draft_confidence[(1*CONF_W) +: CONF_W] = EXP_SLOT0_CONF;

        draft_parent_node_id[(2*`NODE_ID_W) +: `NODE_ID_W] = EXP_PARENT_NODE_ID;
        draft_token_id[(2*`TOKEN_ID_W) +: `TOKEN_ID_W] = 16'h1401;
        draft_referenced_token_id[(2*`TOKEN_ID_W) +: `TOKEN_ID_W] = 16'h9401;
        draft_referenced_position[(2*`POSITION_ID_W) +: `POSITION_ID_W] = 12'h032;
        draft_confidence[(2*CONF_W) +: CONF_W] = 8'd90;

        draft_parent_node_id[(3*`NODE_ID_W) +: `NODE_ID_W] = EXP_PARENT_NODE_ID;
        draft_token_id[(3*`TOKEN_ID_W) +: `TOKEN_ID_W] = EXP_SLOT2_TOKEN_ID;
        draft_referenced_token_id[(3*`TOKEN_ID_W) +: `TOKEN_ID_W] = EXP_SLOT2_REF_TOKEN_ID;
        draft_referenced_position[(3*`POSITION_ID_W) +: `POSITION_ID_W] = EXP_SLOT2_REF_POS;
        draft_confidence[(3*CONF_W) +: CONF_W] = EXP_SLOT2_CONF;
...
task query_kv_tables_once;
    begin
        ...
        kv_lookup_token_id = EXP_SLOT0_REF_TOKEN_ID;
        kv_lookup_position_id = EXP_SLOT0_REF_POS;
        @(posedge clk);
        #1;
        kv_lookup_valid = 1'b0;
    end
...
always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
        ...
        if (tree_window_valid &&
            (tree_window_parent_node_id == EXP_PARENT_NODE_ID) &&
            (tree_window_slot_valid == 4'b1111) &&
            (tree_window_source_id[0 +: SOURCE_ID_W] == EXP_SLOT0_SOURCE_ID) &&
            (tree_window_token_id[0 +: `TOKEN_ID_W] == EXP_SLOT0_TOKEN_ID) &&
            (tree_window_referenced_token_id[0 +: `TOKEN_ID_W] == EXP_SLOT0_REF_TOKEN_ID) &&
            (tree_window_referenced_position[0 +: `POSITION_ID_W] == EXP_SLOT0_REF_POS) &&
            (tree_window_confidence[0 +: CONF_W] == EXP_SLOT0_CONF)) begin
            tree_window_seen_r <= 1'b1;
        end

        if (recompute_req_valid && recompute_req_ready &&
            (recompute_req_token_id == EXP_SLOT0_TOKEN_ID) &&
            (recompute_req_current_position == CURRENT_POSITION) &&
            (recompute_req_referenced_position == EXP_SLOT0_REF_POS) &&
        ...
        if (wb_valid &&
            (wb_token_id == EXP_SLOT0_TOKEN_ID) &&
...
initial begin
    ...
    if (busy !== 1'b1) begin
        $fatal(1, "single-chiplet multibranch top did not enter busy");
    end
    ...
    if (!tree_window_seen_r) begin
        $fatal(1, "single-chiplet multibranch tree window was not observed");
    end
    if ((tree_window_parent_node_id != EXP_PARENT_NODE_ID) ||
        (tree_window_slot_valid != 4'b1111)) begin
        $fatal(1, "single-chiplet multibranch tree window header mismatch");
    end
    expect_window_slot(0, 1'b1, EXP_SLOT0_SOURCE_ID, EXP_SLOT0_TOKEN_ID,
                       EXP_SLOT0_REF_TOKEN_ID, EXP_SLOT0_REF_POS, EXP_SLOT0_CONF);
    expect_window_slot(1, 1'b1, EXP_SLOT1_SOURCE_ID, EXP_SLOT1_TOKEN_ID,
                       EXP_SLOT1_REF_TOKEN_ID, EXP_SLOT1_REF_POS, EXP_SLOT1_CONF);
    expect_window_slot(2, 1'b1, EXP_SLOT2_SOURCE_ID, EXP_SLOT2_TOKEN_ID,
                       EXP_SLOT2_REF_TOKEN_ID, EXP_SLOT2_REF_POS, EXP_SLOT2_CONF);
    expect_window_slot(3, 1'b1, EXP_SLOT3_SOURCE_ID, EXP_SLOT3_TOKEN_ID,
                       EXP_SLOT3_REF_TOKEN_ID, EXP_SLOT3_REF_POS, EXP_SLOT3_CONF);
    ...
    if (!recompute_req_seen_r) begin
        $fatal(1, "single-chiplet multibranch recompute request was not observed");
    end
    if (!debug_stale_hit) begin
        $fatal(1, "single-chiplet multibranch stale hit was not observed");
    end
    if (!debug_recompute_busy) begin
        $fatal(1, "single-chiplet multibranch recompute control did not enter busy");
    end
    ...
    if (!recompute_resp_ready) begin
        $fatal(1, "single-chiplet multibranch recompute response channel was not ready");
    end
    ...
    if (!recompute_done_seen_r) begin
        $fatal(1, "single-chiplet multibranch recompute completion pulse was not observed");
    end

    query_kv_tables_once();
    if (!kv_full_seen_r) begin
        $fatal(1, "single-chiplet multibranch KV full-ready lookup was not observed");
    end

    cycle_count = 0;
    while ((!decoder_qkv_seen_r || !decoder_score_seen_r ||
            !decoder_softmax_seen_r || !decoder_value_seen_r ||
            !decoder_ffn_seen_r || !wb_done) &&
    ...
    if (!decoder_qkv_seen_r) begin
        $fatal(1, "single-chiplet multibranch decoder qkv stage was not observed");
    end
    if (!decoder_score_seen_r) begin
        $fatal(1, "single-chiplet multibranch decoder score stage was not observed");
    end
    if (!decoder_softmax_seen_r) begin
        $fatal(1, "single-chiplet multibranch decoder softmax stage was not observed");
    end
    if (!decoder_value_seen_r) begin
        $fatal(1, "single-chiplet multibranch decoder value stage was not observed");
    end
    if (!decoder_ffn_seen_r) begin
        $fatal(1, "single-chiplet multibranch decoder ffn stage was not observed");
    end
    if (!wb_seen_r) begin
        $fatal(1, "single-chiplet multibranch writeback payload was not observed");
    end
    if (!wb_done) begin
        $fatal(1, "single-chiplet multibranch writeback completion was not observed");
    end
    ...
    if (busy !== 1'b0) begin
        $fatal(1, "single-chiplet multibranch top did not return to idle");
    end
    if (error_flag !== 1'b0) begin
        $fatal(1, "single-chiplet multibranch error flag should stay low");
    end
    if (wb_error !== 1'b0) begin
        $fatal(1, "single-chiplet multibranch writeback error should stay low");
    end
    if (hbm_req_valid !== 1'b0) begin
        $fatal(1, "single-chiplet multibranch minimal path should not issue HBM request");
    end
    if (hbm_req_write !== 1'b0) begin
        $fatal(1, "single-chiplet multibranch minimal path HBM write flag should stay low");
    end
    if (hbm_req_addr != {`HBM_ADDR_W{1'b0}}) begin
        $fatal(1, "single-chiplet multibranch minimal path HBM address should stay zero");
    end
    if (hbm_req_wdata != {`HBM_DATA_W{1'b0}}) begin
        $fatal(1, "single-chiplet multibranch minimal path HBM data should stay zero");
    end
    if (hbm_req_id != {`REQ_ID_W{1'b0}}) begin
        $fatal(1, "single-chiplet multibranch minimal path HBM id should stay zero");
    end

    $display("tb_control_chip_stage2_single_chiplet_multibranch_top_min PASS");
    $finish;
end
