...
module tb_control_chip_second_flush_writeback_closure;

localparam integer CFG_W = 32;
localparam [CFG_W-1:0] RUN_044_WAVE1_CFG_DATA = 32'h0430_0001;
// Wave 2 uses its own bounded config so run_044 can extend run_043 without
// changing the already-proven run_043 second-flush contract.
localparam [CFG_W-1:0] RUN_044_WAVE2_CFG_DATA = 32'h0440_0002;
...
initial begin
    ...
    launch_bounded_scenario(RUN_044_WAVE1_CFG_DATA);
    ...
    launch_bounded_scenario(RUN_044_WAVE2_CFG_DATA);
    ...
    $display("tb_control_chip_second_flush_writeback_closure PASS");
    $finish;
end
