...
module tb_control_chip_tree_driven_serial_long_span_closure;

localparam integer CFG_W = 32;
localparam integer TREE_COUNT = 8;
localparam integer BACK_HALF_START = 4;
localparam [CFG_W-1:0] TREE0_CFG_DATA = 32'h04e0_0000;
localparam [CFG_W-1:0] TREE1_CFG_DATA = 32'h04e0_0001;
localparam [CFG_W-1:0] TREE2_CFG_DATA = 32'h04e0_0002;
localparam [CFG_W-1:0] TREE3_CFG_DATA = 32'h04e0_0003;
localparam [CFG_W-1:0] TREE4_CFG_DATA = 32'h04e0_0004;
localparam [CFG_W-1:0] TREE5_CFG_DATA = 32'h04e0_0005;
localparam [CFG_W-1:0] TREE6_CFG_DATA = 32'h04e0_0006;
localparam [CFG_W-1:0] TREE7_CFG_DATA = 32'h04e0_0007;
...
function [CFG_W-1:0] tree_cfg_word;
    ...
    begin
        case (tree_idx)
            ...
            5: tree_cfg_word = TREE5_CFG_DATA;
            6: tree_cfg_word = TREE6_CFG_DATA;
            7: tree_cfg_word = TREE7_CFG_DATA;
...
task automatic expect_tree_driven_mode_and_descriptor;
    ...
    begin
        ...
        for (cycle_i = 0; cycle_i < MODE_ASSERT_TIMEOUT_CYCLES;
            ...
            @(posedge clk);
            #1;
            if (u_control_chip.scenario_tree_driven_serial_long_span_mode_r &&
        ...
        if (!seen_mode) begin
            $fatal(1,
                   "tree%0d: expected 4'he long-span mode and descriptor id %0d",
                   tree_idx,
                   cfg_word[7:0]);
        end
    end
...
task automatic run_one_tree_and_collect_runtime_class;
    input integer tree_idx;
    input [CFG_W-1:0] cfg_word;
...
initial begin
    ...
    for (tree_i = 0; tree_i < TREE_COUNT; tree_i = tree_i + 1) begin
        run_one_tree_and_collect_runtime_class(
            tree_i,
    ...
    if (busy || error_flag) begin
        $fatal(1,
               "whole_run: control_chip should end the bounded serial long-span tree-driven run without error");
    end

    $display("tb_control_chip_tree_driven_serial_long_span_closure PASS");
    $finish;
end
